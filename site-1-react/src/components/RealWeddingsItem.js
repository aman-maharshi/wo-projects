...
function RealWeddingsItem({ image1, image2, image3, image4, count, name, place }) {
    return (
        <div className="rw__item">
            <div className="rw__item__row1">
                <a href="/real-weddings" className="rw__photo-box">
                    <PhotoItemLarge>
            ...
            <div className="rw__item__row2">
                ...
                <a href="/real-weddings" className="rw__photo-box rw__photo-count">
                    <PhotoItemSmall>
